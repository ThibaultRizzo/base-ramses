...
Revision ID: 64a1e35293d9
Revises: 
Create Date: 2023-05-02 06:23:51.512229
...
def upgrade():
    ...
    op.create_table('daily_features_timeseries',
    ...
    op.create_table('portfolio_line',
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('model_cls', sa.Enum('BAND_MODEL', 'RAMSES_MODEL', name='modelclass', native_enum=False), nullable=False),
    sa.Column('execution_frequency', sa.Enum('HOURLY', 'DAILY', 'WEEKLY', name='modelfrequency', native_enum=False), nullable=False),
    ...
    op.create_table('trading_model_order',
    ...
    op.create_table('trading_model_parameter',
    sa.Column('start_date', sa.Date(), nullable=False),
    sa.Column('end_date', sa.Date(), nullable=False),
