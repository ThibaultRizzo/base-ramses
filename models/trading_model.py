...
from sqlalchemy import TIMESTAMP, Boolean, Column, Date, Enum, Float, ForeignKey, Integer, String
...
class TradingModel(BaseModel):
    ...
    def get_model_cls(self):
        try:
            return getattr(
                __import__(f"trading_models.{camel_to_snake_case(self.model_cls)}", fromlist=[self.model_cls]),
                self.model_cls,
            )
